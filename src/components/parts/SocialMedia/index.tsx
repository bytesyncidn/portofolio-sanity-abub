...
const SocialMedia = () => {
  return (
    <div className="fixed bottom-16 md:bottom-10 bg-white rounded-full md:rounded-s-none py-3 md:py-8 px-3 md:px-24 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-0">
